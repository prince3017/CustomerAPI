...
public class SecurityConfig {
	...
	{
		http.csrf().disable()
		.authorizeHttpRequests().requestMatchers("/","/register","/signin","/saveUser","/customers","/customers/new","/customers","/customers/edit/{id}","/customers/{id}","/customers/{id}").permitAll()
